...
class BarberOwnerHomePage extends StatefulWidget {
  const BarberOwnerHomePage({super.key});

  @override
  State<BarberOwnerHomePage> createState() => _BarberOwnerHomePageState();
}

class _BarberOwnerHomePageState extends State<BarberOwnerHomePage> {
...
// Dashboard content extracted to a separate widget for clarity
